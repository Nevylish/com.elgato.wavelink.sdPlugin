...
class SVGIcon {
    ...
    */
     ...
     */
    _addLayers = () => {
        this.addLayer('background', (o) => `<path ${this._props(o)} fill="#000" d="M0 0h144v144H0z"/>`);
        ...
        this.addLayer('icon', (o) => {
            let svgContent = this.iconSVG && typeof this.iconSVG === 'object' ? this.iconSVG.innerHTML : this.iconSVG;
            
            svgContent = svgContent.replace(/fill="white"/g, `fill="${this.backgroundColor || '#FFF'}"`);
            
            return `<g ${this._props(o)} class="icon">${svgContent}</g>`;
        });
        ...
        this.addLayer('overlay', (o) => `<g ${this._props(o)} ><path id="overlay" fill="#000" d="M29.5736 25.9167l90.5097 90.5097-5.6569 5.6569-90.5097-90.5097 5.6569-5.6569z"/>
                               <path fill="${this.backgroundColor || '#FFF'}" d="M29.5736 23.9167l90.5097 90.5097-5.6569 5.6569-90.5097-90.5097 5.6569-5.6569z"/></g>`, {visible: false, opacity: .9}, ['mute']);
